...
server.setRequestHandler(ListToolsRequestSchema, () => {
    const toolDefinition = {
        ...
        inputSchema: zodToJsonSchema(browsePageToolInfo.inputSchema),
    };
    return {
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    const parseResult = await browsePageToolInfo.inputSchema.safeParseAsync(request.params.arguments);
